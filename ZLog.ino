/* https://github.com/esp8266/Arduino/tree/master
  ...
  ---------------------------------------------------------------------------------------------------------------------
  2026-02-03 - ESP_Gaszaehler_V1_99_Core312_WiFi - Bugfix WiFi keine Neuverbindung nach Wifi connection lost
  . Variables and constants in RAM (global, static), used 37364 / 80192 bytes (46%)
  ║   SEGMENT  BYTES    DESCRIPTION
  ╠══ DATA     1552     initialized variables
  ╠══ RODATA   4172     constants
